...
** Last update Tue Feb  7 18:05:24 2017 Gregoire Renard
*/
...
static void		*split_memory(t_alloc *this,
				      int size)
{
...
void		*malloc(size_t size)
{
  ...
  if (this == NULL && (new_page(&this, size)) == NULL)
    return (option_abort(1));
  split_memory(this, size);
  dexlocker(&mutexm);
  return (option_print(this));
}
